...
import WeatherBoxplotDashboard from './WeatherDashboard';
  ...
  return (
    <div className="dashboard-system-container">
      <div className="dashboard-tabs">
        ...
        <button
          className={`dashboard-tab ${activeTab === 'weather' ? 'active' : ''}`}
      ...
      <div className="dashboard-content">
        ...
        <div id="weather-dashboard" className={`dashboard-tab-content ${activeTab === 'weather' ? 'active' : ''}`}>
          {activeTab === 'weather' && (
            <WeatherBoxplotDashboard
              onRefresh={fetchYearlyData}
            />
          )}
        </div>
